      ...
      <div className="flex flex-col w-full md:w-1/3 justify-item-center mx-auto max-w-80 mt-10 md:mt-0 pr-3">
        <div>
          ...
          <div className="w-1/2 mx-auto">
            <BaseButton title="Choose avatar" variant="primary" type="submit" onClick={toggleModal} className="w-full py-1.5 text-sm" />
            <BaseButton title="Save profile" variant="success" type="submit" className="w-full py-1.5 text-sm" />
            <BaseButton title="Delete profile" variant="danger" type="submit" className="w-full py-1.5 text-sm" />
          </div>
        </div>
      </div>
      {/* modal */}
